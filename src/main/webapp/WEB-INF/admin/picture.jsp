...
<div class="layui-layout layui-layout-admin">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item layui-nav-itemed">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd class="layui-this"><a href="/admin/findAllPicture">图片管理</a></dd>
    ...
    <div class="layui-body">
        <table class="table table-bordered">
            <tr><th>缩略图</th><th>ID</th><th>SRC</th><th>所属帖子</th><th>所属用户</th><th>操作</th></tr>
            <c:forEach items="${blogList}" var="list">
                ...
                <c:forEach items="${picture}" var="picture2">
                    <tr>
                        ...
                        <td>
                            <a type="button" class="btn btn-default btn-xs" href="javascript:;" data-userid="${user.id}" data-pictureid="${picture2.id}" onclick="shanchu(this);">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            </c:forEach>
