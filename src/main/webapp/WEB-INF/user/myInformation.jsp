    ...
    <div class="layui-tab" lay-filter="test" style="width: 930px; margin: auto;background-color: #F8F8F8; margin-bottom: 1%;">
        <div style="margin-left: 32%;">
                <ul class="layui-tab-title">
                    ...
                    <li></li>
                    <li lay-id="44" class="layui-this"><a  href="/user/myInformation" style="text-decoration:none">个人资料</a></li>
                </ul>
        </div>
    </div>
                    ...
                    <form class="layui-form" action="#">
                        ...
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block" style="margin-right: 18px;">
                                <input type="text" name="title" required  lay-verify="required" placeholder="请输入电话号码" autocomplete="off" class="layui-input" maxlength="11" value="${user.phone}" id="phone">
                            </div>
                        </div>
                        <div class="layui-form-item">
